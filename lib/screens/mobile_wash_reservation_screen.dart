...
import '../widgets/reservation/mobile_wash_location_step.dart';
...
class _MobileWashReservationScreenState
  ...
  static const _stepConfig = ReservationStepConfig.mobile;
  ...
  Future<void> _onProviderSelected(int busMstIdx) async {
    final washOptionService = context.read<WashOptionService>();
    setState(() {
