...
class _VehicleRegistrationScreenState extends State<VehicleRegistrationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('차량 정보 등록')),
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: DropdownButtonHideUnderline(
                  child: DropdownButton<String>(
                    ...
                    isExpanded: true,
                    items: ['경차', '소형', '준중형', '중형', '대형', 'SUV', 'RV'].map((
                      type,
                    ) {
              ...
              TextFormField(
                ...
                validator: (value) =>
                    value == null || value.isEmpty ? '모델명을 입력해주세요' : null,
              ),
              const SizedBox(height: 16),
              TextFormField(
                ...
                validator: (value) =>
                    value == null || value.isEmpty ? '차량 번호를 입력해주세요' : null,
              ),
              const SizedBox(height: 16),
              TextFormField(
              ...
              Consumer<VehicleService>(
                builder: (context, vehicleService, child) => ElevatedButton(
                  onPressed: vehicleService.isLoading ? null : _handleRegister,
